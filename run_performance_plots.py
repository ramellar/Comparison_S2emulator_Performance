...
if __name__ == '__main__':
  ...
  if args.total_efficiency:
    ...
    print("\n")
    print("For triangle size 0.0113")
    ...
    print("Number of events after matching",len(pair_cluster_0p0113_matched.pt))
    print("Number of particles after matching",len(ak.flatten(pair_cluster_0p0113_matched.pt,axis=-1)))
    print("\n")
    print("For triangle size 0.016")
    ...
    print("Number of events after matching",len(pair_cluster_0p016_matched.pt))
    print("Number of particles after matching",len(ak.flatten(pair_cluster_0p016_matched.pt,axis=-1)))
    print("\n")
    print("For triangle size 0.03")
    ...
    print("Number of events after matching",len(pair_cluster_0p03_matched.pt))
    print("Number of particles after matching",len(ak.flatten(pair_cluster_0p03_matched.pt,axis=-1)))
    print("\n")
    print("For triangle size 0.045")
    ...
    print("Number of events after matching",len(pair_cluster_0p045_matched.pt))
    print("Number of particles after matching",len(ak.flatten(pair_cluster_0p045_matched.pt,axis=-1)))
    print("\n")
    print("For the reference CMSSW simulation")
    ...
    print("Number of events after matching",len(pair_cluster_Ref_matched.pt))
    print("Number of particles after matching",len(ak.flatten(pair_cluster_Ref_matched.pt,axis=-1)))
