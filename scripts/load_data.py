...
if __name__ == '__main__':
  ...
  parser.add_argument('--base_path', type=str, default='root://cms-xrd-global.cern.ch//store/user/ejclemen/HGCal/Stage2Emulator/double')
 ...
 # Since the dataset is too heavy to load the events every time, we just need to load them once and save them as parquet files
  ...
  events_gen, events_0p0113, events_0p016, events_0p02, events_0p025, events_0p03 , events_0p045, events_Ref =provide_events_performaces(args.n, args.base_path, args.particles, args.pileup, args.n_files, args.pt_cut, args.job_id, args.n_jobs)
  events= [events_gen, events_0p0113, events_0p016, events_0p02, events_0p025, events_0p03 , events_0p045, events_Ref]
